...
class LetterCell: UICollectionViewCell {
  ...
  func set(style: LetterCellStyle) {
    // START YOUR CODE HERE
      ...
      case .correctLetterOnly:
          self.backgroundColor = UIColor(red: 0.69, green: 0.63, blue: 0.33, alpha: 1.0)
          self.layer.backgroundColor = UIColor(red: 0.69, green: 0.63, blue: 0.33, alpha: 1.0).cgColor
      case .correctLetterAndPosition:
